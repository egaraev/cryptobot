...
#################################BUYING ALGORITHM#####################
#If the price for some currency rapidly increased from 25% till 50% OR we have more then 10 big BUY orders on the market, let`s buy something too
            if 25 < percent_chg < 50 or buycountresult >= 10:
...
#If  we got our profit, lets sell this shit
