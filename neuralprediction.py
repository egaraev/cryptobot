...
def learn():
    ...
    for summary in market_summ:  # Loop trough the market summary
        if available_market_list(summary['MarketName']):
            ...
            if (prediction_info(market)[2] == 'UP' and (int(currtime) - int(prediction_info(market)[1])) >= 3600) or (prediction_info(market)[2] == 'UP' and current_price >= prediction_info(market)[0]):
            ...
            elif (prediction_info(market)[2] == 'DOWN' and (int(currtime) - int(prediction_info(market)[1])) >= 3600) or (prediction_info(market)[2] == 'DOWN' and current_price <= prediction_info(market)[0]):
                if (current_price <= prediction_info(market)[0] or (int(currtime) - int(prediction_info(market)[1])) >= 18000):  #21600
