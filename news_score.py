...
#             dates=[dates]
         ...
         #    print (paragraphs)
          ...
          f1 = open("/root/PycharmProjects/cryptobot/csvs/tmp-score.txt", "a")
          print (round(sia.polarity_scores(passage)['compound'], 2), file=f1)
          f1.close()
          f1 = open("/root/PycharmProjects/cryptobot/csvs/tmp-score.txt", "r", newline="\n")
          scores= (f1.readlines())
