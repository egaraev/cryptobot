...
<?php
$con=mysqli_connect("database-service", "cryptouser", "123456", "cryptodb_simulator");
// Check connection
...
echo "<tr>";
//echo "<td>" . $row['name'] . "</td>";
echo "<td><a href='history.php?market=". $row['market'] ."'>". $row['market'] ."</a></td>";
echo "<td>" . $row['current_price'] . "</td>";
echo "<td><a href='../images/symulator/". $row['market'] ."_chart.png'><img src='../images/symulator/". $row['market'] ."_chart.png' width='380px' height='350px'></td>";
echo "<td><a href='../images/symulator/". $row['market'] ."_tweets.png'><img src='../images/symulator/". $row['market'] ."_tweets.png' width='380px' height='350px'></td>";
//echo "<td><b>" . $row['predicted_price'] . "</b></td>";
//echo "<td><a href='../images/symulator/". $row['market'] ."_result.png'><img src='../images/symulator/". $row['market'] ."_result.png' width='250px' height='250px'></td>";
//echo "<td><b>" . $row['ai_direction'] . "</b></td>";
echo "<td><a href='../images/symulator/". $row['market'] ."_hachart.png'><img src='../images/symulator/". $row['market'] ."_hachart.png' width='380px' height='350px'></td>";
echo "<td><a href='../images/symulator/". $row['market'] ."_obv_results.png'><img src='../images/symulator/". $row['market'] ."_obv_results.png' width='380px' height='350px'></td>";
echo "<td><a href='../images/symulator/". $row['market'] ."_macd_results.png'><img src='../images/symulator/". $row['market'] ."_macd_results.png' width='380px' height='350px'></td>";
echo "<td><a href='../images/symulator/". $row['market'] ."_candlesticks.png'><img src='../images/symulator/". $row['market'] ."_candlesticks.png' width='380px' height='350px'></td>";
...
////////////
echo "<br>";
echo "<td><a href='../images/symulator/symulator_crypto_results.png'><img src='../images/symulator/symulator_crypto_results.png' width='800px' height='400px'></a></td>";
