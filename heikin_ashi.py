    ...
    for summary in market_summ: #Loop trough the market summary
        try:
            if available_market_list(summary['MarketName']):
                ...
                if ((ha_direction_down0 and ha_direction_down1 and ha_direction_down2 and ha_direction_down_long_0) or (ha_direction_down0 and ha_direction_down1 and ha_direction_down2 and ha_direction_down_long_0 and ha_direction_down_long_1) or (ha_direction_down0 and ha_direction_down1 and ha_direction_down2 and ha_direction_down_longer) and bought_quantity_sql > 0 and HAD_trend!='UP'):
